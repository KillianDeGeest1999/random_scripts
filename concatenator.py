...
def main():
    ...
    file_name = os.path.splitext(os.path.basename(input_file))[0]  # Extract the input file name without extension
    output_file = f"concatenated_{file_name}.fa"  # Define the output file name with input file name included
